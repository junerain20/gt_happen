...
//创建wakeupfd，用来motify唤醒subReactor处理新来的Channel
int createEventfd()
{
...
void EventLoop::loop()
{
    ...
    while (!quit_)
    {
        ...
        //监听两类fd    一类是client的sockfd，一类是wakeupfd
...
void EventLoop::queueInLoop(Functor cb)
{
    ...
    //当前loop正在执行回调，但是loop又有了新的回调
    //如果不wakeup，那么该loop又回阻塞在poll()中
